...
function ExportsPage() {
  ...
  return (
    <div className="max-w-3xl">
      <h1 className="text-3xl font-bold mb-2 flex items-center gap-2"><FileSpreadsheet className="w-7 h-7" /> Excel exportok</h1>
      <p className="text-muted-foreground mb-6">Töltsd le az üzleted adatait .xlsx formátumban.</p>

      <div className="grid gap-3">
        <Card className="p-4 flex items-center justify-between">
          <div>
            <div className="font-semibold">Szolgáltatás lista</div>
            <div className="text-sm text-muted-foreground">Minden szolgáltatás, ár, időtartam, címkék.</div>
          </div>
        ...
        <Card className="p-4 flex items-center justify-between">
          <div>
            ...
            <div className="text-sm text-muted-foreground">Munkatárs profilok és heti munkaidő.</div>
          </div>
        ...
        <Card className="p-4 flex items-center justify-between">
          <div>
            ...
            <div className="text-sm text-muted-foreground">Termek, eszközök, kapacitások.</div>
          </div>
